...
__all__ = ('Graph', 'Plot', 'MeshLinePlot', 'MeshStemPlot', 'LinePlot', 'SmoothLinePlot','ScatterPlot','ScatterPlot3D','RayPlot3D', 'ContourPlot')
__version__ = '0.4-dev'
...
class Plot(EventDispatcher):
    ...
    points = ObjectProperty(None,force_dispatch=True)
    #points = ListProperty([],force_dispatch=True)
